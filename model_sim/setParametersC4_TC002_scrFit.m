...
params.string.sigma0_Hz  = 0.0454;%0.3;%1.0;          % freq-indep. damping        % tune
params.string.sigma1_s   = 0.0245;%3e-3;%5e-5;         % freq-dep. damping          % tune
...
params.pickups(1).x_m         = 0.0426;%0.045;%0.040;
