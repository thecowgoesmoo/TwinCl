...
include <irkem_clavinetKey_v8_UChannel.scad>
...
//Case bottom:
color("brown",0.6) translate([-230,-100,-12.5-38]) cube([900+254,210+180,12.5]);
...
color("gray",1.0) translate([-22,0+strikeLine_y,0+strikeLine_z-38]) rotate([0,0,skew]) translate([-110,0,0]) difference(){
    cube([1075,38,38]);
    translate([-1,2.6,2.6]) cube([1075+2,38,38]);
}
