...
Our intepretation of sound will always be rooted in the physical world, though.  And the vibrating string is the musical archetype.  With that motivation, I seek here to design an instrument modeled after the Clavinet with the following goals:
-Portable (target weight of 50 lbs or less)
-Affordable (bill of materials costing hundreds, not thousands)
-Low-cost manufacturing (target labor of less than 2 person-days)
-Re-use of commerically available materials where possible
-Parametric CAD scripts, to ease customization
-Explore collaborative design with AI LLM's
