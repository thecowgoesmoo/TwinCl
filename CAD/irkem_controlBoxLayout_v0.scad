...
module pcba(){
    ...
    translate([5,5,-2.5]) cylinder(48,2,2);
    translate([120-5,5,-2.5]) cylinder(48,2,2);
    translate([40,30,-2.5]) cylinder(48,2,2);
    translate([120-40,30,-2.5]) cylinder(48,2,2);
    translate([5,65,-2.5]) cylinder(48,2,2);
    translate([120-5,65,-2.5]) cylinder(48,2,2);
}
