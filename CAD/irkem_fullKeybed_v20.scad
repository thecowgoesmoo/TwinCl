...
module case(){
//Case bottom:
color("white",0.6) translate([-230+100+30,-100+20,-25.4-38]) cube([1215,469,25.4]);
...
color("gray",1.0) translate([0,0+strikeLine_y,-0+strikeLine_z-anvil_action_h-38]) rotate([90,0,0]) translate([-100,0,0]) difference(){
    cube([100+n_keys*13.75+63+200,38,38]);
    translate([-1,2.6,2.6]) cube([100+n_keys*13.75+63+2+200,38,38]);
}
//Right side harp end:
color("gray",1.0) translate([900-20,0+strikeLine_y,-0+strikeLine_z-anvil_action_h-38]) rotate([0,0,15]) difference(){
    cube([38,270,38]);
    translate([2.6,-1,2.6]) cube([38,270+2,38]);
}
//Right side harp end:
color("gray",1.0) translate([1100-20,0+strikeLine_y,-0+strikeLine_z-anvil_action_h-38]) rotate([0,0,15]) difference(){
    cube([38,270+20,38]);
    translate([2.6,-1,2.6]) cube([38,270+2+20,38]);
}
...
color("gray",1.0) translate([-22,0+strikeLine_y,0+strikeLine_z-38]) rotate([0,0,skew]) translate([-110+40,0,0]) difference(){
    cube([1035+150,38,38]);
    translate([-41+40,2.6,2.6]) cube([1035+2+150,38,38]);
}
}
...
color("brown",0.8) difference(){
    translate([900-27,0,-35.4]) rotate([0,0,15]) translate([8,-48,0]) cube([195,280,35.4-3]);
    translate([800,-100,-50]) cube([300,100,100]);
}
